module.exports = [
"[project]/.next-internal/server/app/api/menu/reorder/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
;
;
async function proxyToBackend(path, init = {}) {
...
"[project]/src/app/api/menu/reorder/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backend$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["proxyToBackend"])('/admin/menu/reorder', {
        method: 'POST',
        body: await req.json()
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__18e1c847._.js.map