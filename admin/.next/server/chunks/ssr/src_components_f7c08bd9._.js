...
"[project]/src/components/MenuClient.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MenuClient({ initialItems }) {
   ...
   */ async function optimistic(next, send, fallbackMsg) {
    ...
    async function handleDelete(item) {
        ...
        await optimistic(items.filter((i)=>i.id !== item.id), ()=>fetch(`/api/menu/${item.id}`, {
                method: 'DELETE'
            }), 'Delete failed');
    }
    ...
    /** Close the modal immediately and persist in the background. */ async function handleSave(draft) {
        ...
        if ('id' in draft) {
            const edited = draft;
            const res = await optimistic(items.map((i)=>i.id === edited.id ? edited : i), ()=>fetch(`/api/menu/${edited.id}`, {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                                            ...
                                            children: [
                                                ...
                                                items.map((item)=>{
                                                    ...
                                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        ...
                                                        className: `border-b border-slate-100 last:border-0 transition-colors ${pending ? 'opacity-50 animate-pulse cursor-progress' : 'cursor-grab active:cursor-grabbing'} ${dragId === item.id ? 'opacity-40' : overId === item.id && dragId !== null ? 'bg-gold-50 shadow-[inset_0_2px_0_0_#C9A227]' : !pending ? 'hover:bg-slate-50/60' : ''}`,
                                                        children: [
            ...
            editing && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ItemModal, {
                item: editing,
...
function Toggle({ on, onClick, disabled }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        onClick: onClick,
        disabled: disabled,
        className: `w-10 h-5.5 rounded-full p-0.5 transition-all flex disabled:cursor-not-allowed ${on ? 'bg-emerald-500 justify-end' : 'bg-slate-300 justify-start'}`,
        style: {
            height: '22px',
            width: '40px'
        },
...
function ItemModal({ item, onClose, onSubmit }) {
    const [form, setForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(item);
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Field, {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        className: inputCls,
                                        children: MENU_CATEGORIES.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: c,
                                                children: c
                                            }, c, false, {
                                                fileName: "[project]/src/components/MenuClient.tsx",
...
//# sourceMappingURL=src_components_f7c08bd9._.js.map