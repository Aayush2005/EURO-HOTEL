    ...
    rooms_data = [
        {
            ...
            "images": [
                RoomImage(url="/images/rooms/standard-1.jpg", alt="Standard Heritage Room - Main View", is_primary=True, order=1),
                RoomImage(url="/images/rooms/standard-2.jpg", alt="Standard Heritage Room - Bathroom", is_primary=False, order=2),
                RoomImage(url="/images/rooms/standard-3.jpg", alt="Standard Heritage Room - Heritage View", is_primary=False, order=3),
                RoomImage(url="/images/rooms/standard-4.jpg", alt="Standard Heritage Room - Seating Area", is_primary=False, order=4),
            ],
            "base_price": 8500.0,
            "max_occupancy": 2,
        ...
        },
        {
            ...
            "images": [
                RoomImage(url="/images/rooms/deluxe-1.jpg", alt="Deluxe Heritage Room - Main View", is_primary=True, order=1),
                RoomImage(url="/images/rooms/deluxe-2.jpg", alt="Deluxe Heritage Room - Seating Area", is_primary=False, order=2),
                RoomImage(url="/images/rooms/deluxe-3.jpg", alt="Deluxe Heritage Room - Balcony View", is_primary=False, order=3),
                RoomImage(url="/images/rooms/deluxe-4.jpg", alt="Deluxe Heritage Room - Premium Bathroom", is_primary=False, order=4),
                RoomImage(url="/images/rooms/deluxe-5.jpg", alt="Deluxe Heritage Room - Mini Bar", is_primary=False, order=5),
            ],
            "base_price": 12500.0,
            "max_occupancy": 3,
        ...
        },
        {
            ...
            "images": [
                RoomImage(url="/images/rooms/suite-1.jpg", alt="Heritage Suite - Living Area", is_primary=True, order=1),
                RoomImage(url="/images/rooms/suite-2.jpg", alt="Heritage Suite - Bedroom", is_primary=False, order=2),
                RoomImage(url="/images/rooms/suite-3.jpg", alt="Heritage Suite - Private Balcony", is_primary=False, order=3),
                RoomImage(url="/images/rooms/suite-4.jpg", alt="Heritage Suite - Luxury Bathroom", is_primary=False, order=4),
                RoomImage(url="/images/rooms/suite-5.jpg", alt="Heritage Suite - Dining Area", is_primary=False, order=5),
                RoomImage(url="/images/rooms/suite-6.jpg", alt="Heritage Suite - Heritage View", is_primary=False, order=6),
            ],
            "base_price": 18500.0,
            "max_occupancy": 4,
            "bed_configuration": "1 King Bed + 1 Sofa Bed",
        ...
        },
        {
            ...
            "images": [
                RoomImage(url="/images/rooms/presidential-1.jpg", alt="Presidential Suite - Grand Living Room", is_primary=True, order=1),
                RoomImage(url="/images/rooms/presidential-2.jpg", alt="Presidential Suite - Master Bedroom", is_primary=False, order=2),
                RoomImage(url="/images/rooms/presidential-3.jpg", alt="Presidential Suite - Private Terrace", is_primary=False, order=3),
                RoomImage(url="/images/rooms/presidential-4.jpg", alt="Presidential Suite - Luxury Bathroom", is_primary=False, order=4),
                RoomImage(url="/images/rooms/presidential-5.jpg", alt="Presidential Suite - Dining Area", is_primary=False, order=5),
                RoomImage(url="/images/rooms/presidential-6.jpg", alt="Presidential Suite - Kitchenette", is_primary=False, order=6),
                RoomImage(url="/images/rooms/presidential-7.jpg", alt="Presidential Suite - Heritage View", is_primary=False, order=7),
            ],
            "base_price": 35000.0,
            "max_occupancy": 6,
