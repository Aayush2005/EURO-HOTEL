          ...
          {isAuthenticated ? (
            <div className="relative" ref={userMenuRef}>
              ...
              <AnimatePresence>
                {showUserMenu && (
                  <motion.div
                    className="absolute right-0 top-full mt-2 w-48 bg-white/95 backdrop-blur-md rounded-lg shadow-2xl border border-white/20 z-[60]"
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full px-4 py-3 text-left text-charcoal-700 hover:bg-white/50 transition-colors flex items-center space-x-2 border-t border-white/30 rounded-b-lg"
                    >
                      <LogOut size={16} />
                      <span>Logout</span>
                    </button>
